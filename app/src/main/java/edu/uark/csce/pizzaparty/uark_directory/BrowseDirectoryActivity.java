...
public class BrowseDirectoryActivity extends AppCompatActivity {
    ...
    public static final String TODO_ITEM_EDIT = "todo_item_edit";
    ...
    private void loadAllDirectoryListItems () {
        ...
        DirectoryListItem dummyItem = new DirectoryListItem(dumbyThumbnailUrl, dumbyAppName, dumbyAppDev);
        ...
        DirectoryListItem dummyItem2 = new DirectoryListItem(dumbyThumbnailUrl2, dumbyAppName2, dumbyAppDev2);
